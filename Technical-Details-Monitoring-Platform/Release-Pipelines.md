...
| Production (Customer Integration) | Obsolete pipeline which deploys Customer Integration components **from the production branch** for all customers from the production branch into the Production environment.
